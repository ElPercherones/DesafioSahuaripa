 ...
 *
 */
package net.mcreator.desafosahuaria;
...
@Mod("desafosahuaria")
public class DesafosahuariaMod {
	public static final Logger LOGGER = LogManager.getLogger(DesafosahuariaMod.class);
	public static final String MODID = "desafosahuaria";

	public DesafosahuariaMod() {
