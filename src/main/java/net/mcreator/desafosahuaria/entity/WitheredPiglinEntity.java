...
package net.mcreator.desafosahuaria.entity;
...
public class WitheredPiglinEntity extends Monster {
	public WitheredPiglinEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(DesafosahuariaModEntities.WITHERED_PIGLIN.get(), world);
	}

	public WitheredPiglinEntity(EntityType<WitheredPiglinEntity> type, Level world) {
		super(type, world);
		maxUpStep = 0.6f;
		xpReward = 0;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(DesafosahuariaModEntities.WITHERED_PIGLIN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
