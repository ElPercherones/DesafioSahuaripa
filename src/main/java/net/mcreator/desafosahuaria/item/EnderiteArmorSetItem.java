...
public abstract class EnderiteArmorSetItem extends ArmorItem {
	...
	public static class Helmet extends EnderiteArmorSetItem {
		public Helmet() {
	...
	public static class Chestplate extends EnderiteArmorSetItem {
		public Chestplate() {
	...
	public static class Leggings extends EnderiteArmorSetItem {
		public Leggings() {
	...
	public static class Boots extends EnderiteArmorSetItem {
		public Boots() {
